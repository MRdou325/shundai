...
<body>
    ...
    <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->                        
                            <form class="form-horizontal" role="form" action="<?php echo U('Topic/add');?>" method="post">
                                <?php echo setParam(array('id'=>$id));?>
                              
                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 专题名称 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                                <input type="text" name="name" value="<?php echo ($topic['name']); ?>" class="form-control" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <input type="text" name="order" value="<?php echo intval($topic['order']);?>" class="form-control" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
										...
										<div class="col-sm-9">
                                            <select name="state">
                                                <option value="1" <?php if($topic["status"]==1){ ?>selected<?php } ?>>开启</option>
                                                <option value="0" <?php if($topic["status"]==0){ ?>selected<?php } ?>>关闭</option>
                                            </select>
                                        </div>
                                </div>
