...
<body>
    ...
    <script type="text/javascript" src="/ke361/Public/static/uploadify/jquery.uploadify.min.js"></script>    
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->                        
                            <form class="form-horizontal" role="form" action="<?php echo U('addstatus');?>" method="post">
                                <?php echo setParam(array('id'=>$status['id']));?>

                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 订单状态 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                                <input type="text" name="name" value="<?php echo ($status['name']); ?>" class="form-control" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <input type="text" name="sort" value="<?php echo intval($status['sort']);?>" class="form-control" />
                                        </div>
                                </div>
                                <div class="form-group">
									<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 是否开启 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                            <select name="state">
                                            <option value="1" <?php if($status['status']==1){ ?>selected<?php } ?>>开启</option>
                                            <option value="2" <?php if($status['status']==0){ ?>selected<?php } ?>>关闭</option>
                                            </select>
                                        </div>
                                </div>
