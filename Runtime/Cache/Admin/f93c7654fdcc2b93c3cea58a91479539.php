		...
		<div class="tab-content">
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
                        <label class="item-label"> 首页显示 <span class="check-tips">（是否在首页显示）</span></label>

                        <div class="controls">
                            <select name="ishome">
                                <option value="0" <?php if($info['ishome']==0){ ?>selected<?php } ?>>否</option>
                                <option value="1" <?php if($info['ishome']==1){ ?>selected<?php } ?>>是</option>
                            </select>
                        </div>
                    </div>
					<div class="form-item">
