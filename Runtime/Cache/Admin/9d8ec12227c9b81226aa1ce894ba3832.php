...
<body>
    ...
    <script type="text/javascript" src="/ke361/Public/static/uploadify/jquery.uploadify.min.js"></script>    
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->                        
                            <form class="form-horizontal" role="form" action="<?php echo U('FriendLink/add');?>" method="post">
                                <?php echo setParam(array('id'=>$FriendLink['aid']));?>

                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 名称 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                                <input type="text" name="title" value="<?php echo ($FriendLink['title']); ?>" class="form-control" />
                                        </div>
                                </div>
                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 网站logo地址 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                                <input type="text" name="pic_url" value="<?php echo ($FriendLink['pic_url']); ?>" class="form-control" />
                                        </div>
                                </div>
                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 网址 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                                <input type="text" name="url" value="<?php echo ($FriendLink['url']); ?>" class="form-control" />
                                        </div>
                                </div>
                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 是否打开新的窗口 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                            <select name="blank">
                                            <option value="1" <?php if($FriendLink['blank']==1){ ?>selected<?php } ?>>是</option>
                                            <option value="2" <?php if($FriendLink['blank']==0){ ?>selected<?php } ?>>否</option>
                                            </select>
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <input type="text" name="sort" value="<?php echo intval($FriendLink['sort']);?>" class="form-control" />
                                        </div>
                                </div>
                                <div class="form-group">
									<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 是否开启 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                            <select name="state">
                                            <option value="1" <?php if($FriendLink['state']==1){ ?>selected<?php } ?>>开启</option>
                                            <option value="2" <?php if($FriendLink['state']==0){ ?>selected<?php } ?>>关闭</option>
                                            </select>
                                        </div>
                                </div>
