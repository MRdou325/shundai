...
<body>
    ...
    <script type="text/javascript" src="/ke361/Public/static/uploadify/jquery.uploadify.min.js"></script>    
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->                        
                            <form class="form-horizontal" role="form" action="<?php echo U('Banner/add');?>" method="post">
                                <?php echo setParam(array('id'=>$banner['id']));?>
                                
                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 图片 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                                <input type="file" id="upload_picture">
                                                <input type="hidden" name="image" id="image" value="<?php echo ((isset($banner['image']) && ($banner['image'] !== ""))?($banner['image']):''); ?>"/>
                                                <div class="upload-img-box">
                                                <?php if(!empty($$banner['image'])): ?><div class="upload-pre-item"><img src="/ke361<?php echo (get_cover($banner["image"],'path')); ?>"/></div><?php endif; ?>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <input type="text" name="title" value="<?php echo ($banner['title']); ?>" class="form-control" />
                                        </div>
                                </div>
                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 链接 <span style="color:#f00;">*</span></label>
                                        <div class="col-sm-9">
                                                <input type="text" name="link" value="<?php echo ($banner['link']); ?>" class="form-control" />
                                                *可以为网站地址也可以为视频地址
                                        </div>
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="type">
                                            <option value="1" <?php if($banner['type']==1){ ?>selected<?php } ?>>链接</option>
                                            <option value="2" <?php if($banner['type']==2){ ?>selected<?php } ?>>视频</option>
                                            </select>
                                        </div>
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <textarea type="text" name="content" class="form-control" /><?php echo ($banner['content']); ?></textarea>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <input type="text" name="sort" value="<?php echo intval($banner['sort']);?>" class="form-control" />
                                        </div>
                                </div>
                                <div class="form-group">
									<div class="checkbox col-sm-3 col-sm-offset-2">
											...
											<label>
											   开启/关闭 <input name="status" class="ace ace-switch ace-switch-7" type="checkbox" <?php if($banner && empty($banner['status'])){ }else{ ?>checked='checked'<?php } ?> value='1'>
