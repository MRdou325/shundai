                        ...
                        <!-- PAGE CONTENT BEGINS -->                        
                            <form class="form-horizontal" role="form" action="<?php echo U('add');?>" method="post">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <input type="text" name="name" value="<?php echo ($support['name']); ?>" class="form-control" />
                                        </div>
                                </div>
                                
                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 号码 <span style="color:#f00;">*</span></label>

                                        <div class="col-sm-9">
                                                <input type="text" name="number" value="<?php echo intval($support['number']);?>" class="form-control" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <input type="text" name="sort" value="<?php echo intval($support['sort']);?>" class="form-control" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
										...
										<div class="col-sm-9">
                                            <select name="isshow">
                                                <option value="1" <?php if($support["isshow"]==1){ ?>selected<?php } ?>>开启</option>
                                                <option value="0" <?php if($support["isshow"]==0){ ?>selected<?php } ?>>关闭</option>
                                            </select>
                                        </div>
                                </div>
