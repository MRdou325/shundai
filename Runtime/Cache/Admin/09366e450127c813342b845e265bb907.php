                    ...
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->                        
                            <form class="form-horizontal" role="form" action="<?php echo U('CategoryGoods/add');?>" method="post">
                                ...
                                <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 旅游线路 <span style="color:#f00;">*</span></label>

                                        <div class="col-sm-9">
                                            <select name="istravel">
                                                 <option value="0" <?php if($category["istravel"]==0){ ?>selected<?php } ?>>否</option>
                                                 <option value="1" <?php if($category["istravel"]==1){ ?>selected<?php } ?>>是</option>
                                            </select>
                                            (仅对第一级分类有效，显示在首页的分类导航条)
                                        </div>
                                </div>
