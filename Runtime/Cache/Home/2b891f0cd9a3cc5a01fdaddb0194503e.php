                ...
                <div class="tag_con" id="js_tag_con">                                                                        
                    <div class="tu_wen">
                        ...
                        <form class="form-horizontal J_ajaxForm" action="<?php echo u('profile/edit_post');?>" method="post">
                            <li>
                                <label class="control-label col-md-3" for="">用户名</label>
                                <div class="col-md-3">
                                    <input type="text" readonly class="form-control" id="" value="<?php echo ($my['username']); ?>">
                                </div>
                            </li>
                            
                            <li>
                                <label class="control-label col-md-3" for="">邮箱</label>
                                <div class="col-md-3">
                                    <input type="text" readonly class="form-control" id="" value="<?php echo ($my['email']); ?>">
                                </div>
                            </li>
                            
                            <li>
                                <label class="control-label col-md-3" for="">注册时间</label>
                                <div class="col-md-3">
                                    <input type="text" readonly class="form-control" id="" value="<?php echo date('Y-m-d H-i-s',$my['regtime']);?>">
                                </div>
                            </li>
                            
                            <li>
                                <label class="control-label col-md-3" for="">上次登录时间</label>
                                <div class="col-md-3">
                                    <input type="text" readonly class="form-control" id="" value="<?php echo date('Y-m-d H:i:s',$my['last_login_time']);?>">
                                </div>
                            </li>
                            
                            <li>
                                <label class="control-label col-md-3" for="">上次登录IP</label>
                                <div class="col-md-3">
                                    <input type="text" readonly class="form-control" id="" value="<?php echo ($my['last_login_ip']); ?>">
                                </div>
                            </li>
                            
                            <li>
                                <label class="control-label col-md-3" for="">积分</label>
                                <div class="col-md-3">
                                    <input type="text" readonly class="form-control" id="" value="<?php echo intval($my['score']);?>">
                                </div>
                            </li>
