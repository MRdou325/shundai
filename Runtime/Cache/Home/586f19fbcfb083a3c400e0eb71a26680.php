...
<script src="/ke361/Public/Home/js/jquery.Jcrop.js"></script>
<link rel="stylesheet" href="/ke361/Public/Home/css/jquery.Jcrop.css" type="text/css" />  
<div class="container user-center">
    ...
    <a class="list-group-item" href="<?php echo U('User/orders');?>"><i class="fa fa-star"></i> 报名线路</a>
</div>
        </div>
        <div class="col-md-10">
            <div class="list790">
                ...
                <div class="tag_con" id="js_tag_con">                                                                        
                    <div class="tu_wen">
                        <ul>
                        <form class="form-horizontal J_ajaxForm" action="<?php echo u('User/Cropavatar');?>" method="post" enctype="multipart/form-data">
                            <li>
                            ...
                            <li>
                                ...
                                <div id="avatar"><img src="<?php echo ($my["avatar"]); ?>"></div>
                            </li>                                                                                                           
                ...
                <script type="text/javascript">
                    ...
                    $("#upload_picture").uploadify({
                        ...
                        "buttonText"      : "选择头像",
                        "uploader"        : "<?php echo U('Ajax/uploadPicture',array('session_id'=>session_id()));?>",
                        "width"           : 120,
                        'removeTimeout'   : 1,
