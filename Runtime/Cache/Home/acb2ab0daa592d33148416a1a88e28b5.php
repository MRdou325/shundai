...
<?php if($iscate == 1){ ?>
    <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><div class="list790">
        ...
        <div class="tag_con" id="js_tag_con">                                                                        
            <div class="tu_wen">
                <ul>
                    <?php if(is_array($cate["goods"])): $i = 0; $__LIST__ = $cate["goods"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?><li>
                        <div class="pic">
...
<?php }else{ ?>
    ...
    <div class="list790">
        ...
        <div class="tag_con" id="js_tag_con">                                                                        
            <div class="tu_wen">
                <ul>
                    <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?><li>
                        <div class="pic">
                            <a href="<?php echo U('Goods/info',array('id'=> $goods["goods_id"]));?>" target="_blank" title="<?php echo ($goods["title"]); ?>">
                                <img src="<?php echo ($goods['pic_url']); ?>" border="0" alt="<?php echo ($goods["title"]); ?>" width="75" height="50" original="<?php echo ($goods['pic_url']); ?>" style="display: block;">
                            </a>
