...
DROP TABLE IF EXISTS `wu_action`;
CREATE TABLE `wu_action` (
...
DROP TABLE IF EXISTS `wu_action_log`;
CREATE TABLE `wu_action_log` (
...
DROP TABLE IF EXISTS `wu_addons`;
CREATE TABLE `wu_addons` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
DROP TABLE IF EXISTS `wu_article`;
CREATE TABLE `wu_article` (
...
DROP TABLE IF EXISTS `wu_attachment`;
CREATE TABLE `wu_attachment` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wu_attribute`;
CREATE TABLE `wu_attribute` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wu_auth_extend`;
CREATE TABLE `wu_auth_extend` (
...
DROP TABLE IF EXISTS `wu_banner`;
CREATE TABLE `wu_banner` (
...
DROP TABLE IF EXISTS `wu_category`;
CREATE TABLE `wu_category` (
...
INSERT INTO `wu_category` (`id`, `name`, `title`, `pid`, `sort`, `list_row`, `meta_title`, `keywords`, `description`, `template_index`, `template_lists`, `template_detail`, `template_edit`, `model`, `type`, `link_id`, `allow_publish`, `display`, `reply`, `check`, `reply_model`, `extend`, `create_time`, `update_time`, `status`, `icon`) VALUES
...
DROP TABLE IF EXISTS `wu_category_goods`;
CREATE TABLE `wu_category_goods` (
...
DROP TABLE IF EXISTS `wu_collect_goods`;
CREATE TABLE `wu_collect_goods` (
...
DROP TABLE IF EXISTS `wu_config`;
CREATE TABLE `wu_config` (
...
(5, 'WEB_SITE_LOGO', 1, '网站logo', 1, '', '网站标题前台显示LOGO', 1439171677, 1439349726, 1, '/ke361/Uploads/site_logo/55cabbd7249a5.gif', 0),
...
(62, 'BANNER_WIDTH', 0, '幻灯片的宽度', 6, '', '幻灯片的宽度', 1439371173, 1439376224, 1, '1200', 1),
...
DROP TABLE IF EXISTS `wu_document`;
CREATE TABLE `wu_document` (
...
DROP TABLE IF EXISTS `wu_document_article`;
CREATE TABLE `wu_document_article` (
...
DROP TABLE IF EXISTS `wu_document_download`;
CREATE TABLE `wu_document_download` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
DROP TABLE IF EXISTS `wu_favor`;
CREATE TABLE `wu_favor` (
...
DROP TABLE IF EXISTS `wu_file`;
CREATE TABLE `wu_file` (
...
DROP TABLE IF EXISTS `wu_friendlink`;
CREATE TABLE `wu_friendlink` (
...
DROP TABLE IF EXISTS `wu_goods`;
CREATE TABLE `wu_goods` (
  ...
  `city` varchar(255) NOT NULL COMMENT '出发城市',
...
DROP TABLE IF EXISTS `wu_goods_extra`;
CREATE TABLE `wu_goods_extra` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wu_goods_to_tags`;
CREATE TABLE `wu_goods_to_tags` (
  `goods_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `wu_hooks`;
CREATE TABLE `wu_hooks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
DROP TABLE IF EXISTS `wu_link`;
CREATE TABLE `wu_link` (
...
DROP TABLE IF EXISTS `wu_member`;
CREATE TABLE `wu_member` (
...
DROP TABLE IF EXISTS `wu_model`;
CREATE TABLE `wu_model` (
...
DROP TABLE IF EXISTS `wu_orders`;
CREATE TABLE `wu_orders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `wu_orders_status`;
CREATE TABLE `wu_orders_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wu_page`;
CREATE TABLE `wu_page` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
...
DROP TABLE IF EXISTS `wu_picture`;
CREATE TABLE `wu_picture` (
...
DROP TABLE IF EXISTS `wu_scheme_keyword`;
CREATE TABLE `wu_scheme_keyword` (
...
DROP TABLE IF EXISTS `wu_search_keyword`;
CREATE TABLE `wu_search_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wu_support`;
CREATE TABLE `wu_support` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
...
DROP TABLE IF EXISTS `wu_topic`;
CREATE TABLE `wu_topic` (
...
DROP TABLE IF EXISTS `wu_ucenter_admin`;
CREATE TABLE `wu_ucenter_admin` (
...
DROP TABLE IF EXISTS `wu_ucenter_app`;
CREATE TABLE `wu_ucenter_app` (
...
DROP TABLE IF EXISTS `wu_ucenter_member`;
CREATE TABLE `wu_ucenter_member` (
...
DROP TABLE IF EXISTS `wu_ucenter_setting`;
CREATE TABLE `wu_ucenter_setting` (
...
DROP TABLE IF EXISTS `wu_userdata`;
CREATE TABLE `wu_userdata` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
